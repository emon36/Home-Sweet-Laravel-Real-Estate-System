...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item " aria-current="page"> <a href="{{route('admin.properties')}}">Manage Properties</a></li>
        ...
        <div class="col-12  mt-3">
            <div class="card mb-md-0">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('admin.property.update',$property->id)}}"  method="POST" enctype="multipart/form-data">
                        @csrf
