        ...
        <div class="col-10 mx-auto mt-3">
            <div class="card mb-md-0">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('admin.user.update_customer',$user->id)}}"  method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row mb-3">
                            <label for="inputName" class="col-3 col-form-label">Full Name</label>
                            <div class="col-9">
                                <input type="text" class="form-control  @error('name') is-invalid @enderror" id="inputName"  placeholder="Enter Full Name" name="name" value="{{$user->name}}">
                                @error('name')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="inputEmail" placeholder="Enter a Valid Email" name="email" value="{{$user->email}}">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <input type="number" class="form-control @error('phone') is-invalid @enderror" id="inputPhone" placeholder="Enter Phone Number" name="phone" value="{{$user->phone}}">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control @error('username') is-invalid @enderror" id="inputUserAddress" placeholder="Enter User Address" name="address" value="{{ $user->address }}">
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control @error('tin') is-invalid @enderror" id="inputUsertin" placeholder="Enter TIN Number" name="tin" value="{{ $user->tin }}">
                                @error('tin')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                ...
                                <img src="{{asset('uploads/profileImages/'.$user->image)}}" width="150px">
                            </div>
                        </div>
