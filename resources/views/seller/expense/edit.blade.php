...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item " aria-current="page"> <a href="{{route('seller.expense.index')}}">Manage Expenses</a></li>
        ...
        <div class="col-10 mx-auto mt-3">
            <div class="card mb-md-0">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('seller.expense.update',$expense->id)}}"  method="POST" enctype="multipart/form-data">
                        @csrf
