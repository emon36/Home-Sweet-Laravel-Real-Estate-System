...
class TransactionController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ->addColumn('action', function($row){
                    $btn = '<a href="'.route('seller.payment.invoice',$row->id).'"  title="download invoice" data-toggle="tooltip"  data-placement="bottom" class="edit btn btn-primary btn-sm"><i class=" mdi mdi-download"></i></a> ';
                    $btn .= '<a href="'.route('seller.payment.confirmation',$row->id).'"  title="send confirmation" data-toggle="tooltip"  data-placement="bottom" class="edit btn btn-primary btn-sm"><i class=" mdi mdi-message "></i></a> ';
    ...
    public function show($id)
    {
        ...
        return view('seller.transaction.show',['transaction'=>$transaction]);
    }

    public function create($id)
    {
        $order = Order::find($id);
        return view('seller.transaction.create',['order'=>$order]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('success','Payment added Succesfully');
    ...
    public function paymentInvoice($id)
    {
        ...
        $pdf = PDF::loadView('seller.transaction.invoice',['transaction'=>$transaction]);
