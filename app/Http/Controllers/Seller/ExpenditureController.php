...
class ExpenditureController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('seller.expense.index',['expenses'=>$expenses]);
    }

    public function create()
    {
        $projects = Project::all();
        return view('seller.expense.create',['projects'=>$projects]);
    }
    ...
    public function show($id)
    {
        ...
        return view('seller.expense.show',['expense'=>$expense]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('seller.expense.edit',['projects'=>$projects,'expense'=>$expense]);
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        if ($expense->status == 0)
        {
            return redirect()->back()->with('error','You can not update this');
        }
        $expense->project_id = $request->project;
        $expense->submitted_by = auth()->user()->name;
        $expense->description = $request->description;
