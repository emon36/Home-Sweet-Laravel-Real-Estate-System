...
class ContactController extends Controller
{
    ...
    {
        return view('seller.contact.index');
    }
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $btn = '<a "'.route('seller.contact.view',$row->id).'"  title="view"  data-toggle="tooltip" class="edit btn btn-primary btn-sm editUser"><i class="mdi mdi-eye"></i></a>';
    ...
    public function show($id)
    {
        ...
        return view('seller.contact.show',['contact'=>$contact]);
    }
